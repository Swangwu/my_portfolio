...
function ProjectCard({ project, index, isVisible }: { project: { title: string; category: string; year: string; image: string; featured?: boolean; link?: string }; index: number; isVisible: boolean }) {
  const cardContent = (
    <>
